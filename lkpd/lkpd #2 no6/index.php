...
// array associative adalah sebuah array yang berisi indeks dan elemen-nya
$barang = [
    [
...
// $item adalah sebuah variabel
// as adalah sebuah operator
// $subPrice adalah sebuah variabel
foreach ($barang as $item) {
    $subPrice = $item['harga_barang'] * $item['jumlah_beli'];

    echo "<li>" . $item['nama_barang'] . " (" . $item['jumlah_beli'] . ") : " . number_format($subPrice, 0, ".", ".");

    // += adalah sebuah operator untuk menambahkan sebuah nilai
    $price += $subPrice;
}
